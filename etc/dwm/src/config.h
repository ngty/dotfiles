...
static const char selfgcolor[]      = "#ff9900";
...
/* commands */
static const char *dmenucmd[] = { "dmenu_run", "-fn", "Ubuntufont-20", "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbgcolor, "-sf", selfgcolor, "-b", "-l", "5", NULL };
